...
func (woc *wfOperationCtx) createWorkflowPod(ctx context.Context, nodeName string, mainCtrs []apiv1.Container, tmpl *wfv1.Template, opts *createWorkflowPodOpts) (*apiv1.Pod, error) {
	log.Trace("++++++++++++++++++++++++++++++++++++姜猛修改标记，开始调用createWorkflowPod方法+++++++++++++++++++++++++")

	nodeID := woc.wf.NodeID(nodeName)
	log.Trace("++++++++++++++++++++姜猛修改标记，输出nodeID的值为：" + nodeID + " 输出完毕++++++++++++++++++++")
	...
	log.Trace("++++++++++++++++++++++姜猛修改标记，输出wfDeadline的值为:" + wfDeadline.String() + " 输出完毕++++++++++++++++++++++++++++")
	...
	log.Trace("+++++++++++++++姜猛修改标记，k8s中pod已经创建完毕+++++++++++++++++++++++")
