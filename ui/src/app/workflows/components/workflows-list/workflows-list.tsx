...
class WorkflowsList extends BasePage<RouteComponentProps<any>, State> {
    ...
    public render() {
        ...
        const { t } = this.props;
        console.log("11111111111111111111111111111",this.props);
        return (
            <Consumer>
                {ctx => (
                    <Page
                        ...
                        toolbar={{
                            ...
                            actionMenu: {
                                items: [
                                    {
                                        title: <p>{t('actionMenu-items.title')}</p>,
                                        // title: '提交工作流',
                                   ...
                                   // {
                                    //     title: <p><Home></Home></p>,
                                    //     // title: '提交工作流',
                                    //     action: () => console.log("姜猛修改标记调用了改变语言的方法")                                    
                                    // } 
                                ]
                            }
                        }}>
                        ...
                        {/* <div>
                            <h1>{t('actionMenu-items.title')}</h1>
                        </div> */}
        ...
        return (
            <>
                ...
                {!this.state.workflows ? (
                    ...
                    <ZeroState title={t('actionMenu-items.title')}>
                        <p>{t('tips.tip1')}</p>
                        <p>
                            <ExampleManifests />.
                        </p>
...
export default withTranslation()(WorkflowsList);
