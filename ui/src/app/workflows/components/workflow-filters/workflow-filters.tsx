...
class WorkflowFilters extends React.Component<WorkflowFilterProps, {}> {
        ...
        return (
            <div className='wf-filters-container'>
                <div className='row'>
                    ...
                    <div className='columns small-2 xlarge-12'>
                        <p className='wf-filters-container__title'>{t('left.left3')}</p>
                        <DataLoaderDropdown
                            load={() =>
                    ...
                    <div className='columns small-2 xlarge-12'>
                        <p className='wf-filters-container__title'>{t('left.left4')}</p>
                        <DataLoaderDropdown
                    ...
                    <div className='columns small-4 xlarge-12'>
                        <p className='wf-filters-container__title'>{t('left.left5')}</p>
                        <CheckboxFilter
...
export default withTranslation()(WorkflowFilters);
